...
Dabei sind die $a_{ij}$ und $b_i$ reelle oder komplexe Zahlen. Die $a_{ij}$ heißen \begr{Koeffizienten, LGS} des LGS. Sind alle $b_i$ gleich Null, so heißt das LGS \begr[Homogenes LGS]{homogen}, sonst \begr[Inhomogenes LGS]{inhomogen}.
