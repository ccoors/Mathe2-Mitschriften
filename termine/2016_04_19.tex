...
Zwei Vektoren $x, y \in \mathbb{R}^n$ heißen \begr{orthogonal} oder \begr{senkrecht} zueinander, falls $\langle x, y\rangle = 0$.
...
\mdf{Definition}
Eine Menge von Vektoren $v_1,\dots,v_k \in \mathbb{R}^n$ heißt \begr{orthogonales System}, falls für alle $1\leq i, j \leq k, i\neq j$ gilt: $\langle v_i, v_j\rangle = 0$.
